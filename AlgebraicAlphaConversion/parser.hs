...
happyExpList = Happy_Data_Array.listArray (0,42) ([1728,216,24576,3,0,32,49204,6,14848,128,0,40960,1,128,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","start","line","exp","NL","VAR","'.'","'\955'","'('","')'","%eof"]
...
action_16 (6) = happyGoto action_12
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	NewLine -> cont 7;
	Term happy_dollar_dollar -> cont 8;
	Dot -> cont 9;
	Lambda -> cont 10;
	OpenPar -> cont 11;
	ClosedPar -> cont 12;
